...
# ---------------------------------------------------------------------------
def test_derive_temp_media(spark_session) -> None:
...
def test_derive_temp_media_preserves_original_columns(spark_session) -> None:
...
def test_derive_temp_media_does_not_mutate_input(spark_session) -> None:
...
# add_city_key tests
# ---------------------------------------------------------------------------
def test_add_city_key(spark_session) -> None:
...
def test_add_city_key_does_not_mutate_input(spark_session) -> None:
...
# read_csv tests
# ---------------------------------------------------------------------------
def test_read_csv_with_header_and_schema_inference(spark_session) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        df = read_csv(spark_session, str(csv_path))
...
# write_parquet tests
# ---------------------------------------------------------------------------
def test_write_parquet_produces_output(spark_session) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        write_parquet(df, str(output_path), partition_cols=["cidade"])
